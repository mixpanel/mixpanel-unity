...
def bump_version():
    replace_version('package.json', args.old, args.new)
    replace_version('./Mixpanel/MixpanelAPI.cs', args.old, args.new)
    subprocess.call('git add package.json', shell=True)
    subprocess.call('git add ./Mixpanel/MixpanelAPI.cs', shell=True)
