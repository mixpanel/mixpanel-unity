...
typedef struct
{
    ...
    mixpanel_mbedtls_aes_context aes_ctx;        /*!<  AES context       */
 ...
 */
void mixpanel_mbedtls_ctr_drbg_set_prediction_resistance( mixpanel_mbedtls_ctr_drbg_context *ctx,
                                         int resistance );
 ...
 */
void mixpanel_mbedtls_ctr_drbg_set_entropy_len( mixpanel_mbedtls_ctr_drbg_context *ctx,
                               size_t len );
 ...
 */
void mixpanel_mbedtls_ctr_drbg_set_reseed_interval( mixpanel_mbedtls_ctr_drbg_context *ctx,
                                   int interval );
 ...
 *                      MBEDTLS_ERR_CTR_DRBG_REQUEST_TOO_BIG
 */
int mixpanel_mbedtls_ctr_drbg_random( void *p_rng,
                     unsigned char *output, size_t output_len );
...
int mixpanel_mbedtls_ctr_drbg_seed_entropy_len( mixpanel_mbedtls_ctr_drbg_context *,
