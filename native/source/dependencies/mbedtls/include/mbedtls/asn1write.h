 ...
 * \return          the length written or a negative error code
 */
int mixpanel_mbedtls_asn1_write_tag( unsigned char **p, unsigned char *start,
                    unsigned char tag );
 ...
 */
mixpanel_mbedtls_asn1_named_data *mixpanel_mbedtls_asn1_store_named_data( mixpanel_mbedtls_asn1_named_data **list,
                                        const char *oid, size_t oid_len,
